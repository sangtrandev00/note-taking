---
layout: post
title: "VÒNG 1 - Trải nghiệm phỏng vấn công ty Fullerton Health ngày 19-12-2024"
date: 2025-12-22 10:00:00 +0700
categories: concept-base technical interview fullteron health
tags: ["nodejs", "nestjs", "mongodb", "mysql", "docker", "aws", "javascript", "typescript", "database", "sql", "interview", "programming", "backend"]
source_path: "Evergreen/concept-base/technical/interview/fullteron health/VÒNG 1 - Trải nghiệm phỏng vấn công ty Fullerton Health ngày 19-12-2024.md"
---
	...
	+ Quá trình làm việc bạn có thiết kế database không ?
		+ Bạn đã thiết kế nó như thế nào ?
			...
			+ Sử dụng trigger
				...
				+ Before insert
				+ Cho ví dụ ?
	+ So sánh giữa left join và right join
	+ Thứ tự thực hiện của một câu lệnh SQL query như thế nào ?
	+ **Transaction**
...
---
*Nguồn: Evergreen/concept-base/technical/interview/fullteron health/VÒNG 1 - Trải nghiệm phỏng vấn công ty Fullerton Health ngày 19-12-2024.md*